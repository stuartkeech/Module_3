...
<div id="main-body">
		...
		<p id="role">
			<c:choose>
				<c:when test="${role != null}">
					<c:out value="${role}">${role}</c:out><br/>
				</c:when>
				<c:otherwise>
					Not Logged In<br/>
				</c:otherwise>
	...
	<div id="widgetmain"
		style="text-align: left; overflow-y: auto; overflow-x: hidden; width: 350px; background-color: #transparent; border: 1px solid #333333;">
		<div id="rsswidget" style="height: 500px;">
			<iframe
				...
				marginheight="0"
				style="border: 0; padding: 0; margin: 0; width: 350px; height: 500px;"
